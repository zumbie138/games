class EnText:
    ...
    INPUT_MENU_RACE = 'Choose your race: \n [ 1 ] - Human.\n [ 2 ] - Elf.\n [ 3 ] - Orc.\n'
    INPUT_MENU_CLASS = 'Choose your class: \n [ 1 ] - {class_1}.\n [ 2 ] - {class_2}.\n [ 3 ] - {class_3}'
    INPUT_CHOICE = 'Choose a option:\n'
    NEW_CHAR_TEXT = 'Starting new character.'
    ...
    PLAYER_LEVEL = 'You are level {player_level}, with {player_experience} of experience and your atributes are:\nStrength: {player_strength:.2f}\nAgility: {player_agility:.2f}\nVitality: {player_vitality:.2f}\nInteligence: {player_intelligence:.2f}\nCharisma: {player_charisma:.2f}'
    PLAYER_BATTLE_LVL = 'Attack:{player_attack:.2f} Defense:{player_defense:.2f} attack speed:{player_attack_speed:.2f}'
    PLAYER_SPELL_LIST = 'Your list of spells: {player_spells}'
